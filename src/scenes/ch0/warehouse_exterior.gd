...
#   it"), the path back to the home exterior, and the door into the warehouse interior.
# does not own: what's inside (see warehouse_interior.tscn), or anything Marigold- or
#   Jack-speaking-her-name-related (C0-019/C0-020), since that content is not written yet
